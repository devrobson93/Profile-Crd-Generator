...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition} ">
            ...
            <li><a href="https://github.com/${variables.github}"><i class="fa-brands fa-github"></i></li>
            <li><a href="https://www.linkedin.com/in/${variables.linkedin}"><i class="fa-brands fa-linkedin"></i></a></li>
            <li><a href="https://www.instagram.com/${variables.instagram}"><i class="fa-brands fa-square-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
...
window.onload = function() {
  window.variables = {
    ...
    avatarURL:
      "https://www.andiar.com/2287-thickbox_default/vinilo-heisenberg.jpg",
    // social media bar position (left or right)
    socialMediaPosition: "position-left",
    // social media usernames
    twitter: "4geeksacademy",
    github: "alesanchezr",
    linkedin: "hansaparicio",
